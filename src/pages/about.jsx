    ...
    <>
      ...
      <main className='pt-20'>
        <Container className='py-32'>
          ...
          <p className='mt-4 text-center text-3xl xl:text-6xl xl:leading-snug leading-snug'>To organise the world's <span className='text-gg-blue font-semibold'>game data</span> and make it <span className='text-gg-red font-semibold'>universally accessible</span> and useful.</p>
          
          <p className='mt-40 text-center text-xl text-gray-400'>OUR STORY</p>
