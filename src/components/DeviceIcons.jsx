...
export function DeviceUserIconLight(props) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
...
export function DeviceUserIconDark(props) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#A3A3A3" fillOpacity={0.2} />
      <path
...
export function DeviceListIconLight(props) {
  return (
    <svg viewBox="0 0 32 32" fill="none" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
...
export function DeviceListIconDark(props) {
  return (
    <svg viewBox="0 0 32 32" fill="none" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
...
export function DeviceChartIconLight(props) {
  return (
    <svg viewBox="0 0 32 32" fill="none" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
...
export function DeviceChartIconDark(props) {
  return (
    <svg viewBox="0 0 32 32" fill="none" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
...
export function DeviceMessageIcon(props) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#A3A3A3" fillOpacity={0.2} />
      <path
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M17 18a2 2 0 00-2 2v6a2 2 0 002 2h1.5l3 3V28H25a2 2 0 002-2v-6a2 2 0 00-2-2h-8z"
        fill="#171717"
      />
    </svg>
  )
...
export function DeviceMessageIconLight(props) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#C3C3C3" fillOpacity={0.2} />
      <path
...
export function DeviceMessageIconDark(props) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#A3A3A3" fillOpacity={0.2} />
      <path
...
export function DeviceOfflineIcon(props) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#A3A3A3" fillOpacity={0.2} />
      <path
...
export function DeviceTouchIconLight(props) {
  return (
    <svg viewBox="0 0 32 32" fill="none" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#C3C3C3" fillOpacity={0.2} />
      <path
...
export function DeviceTouchIconDark(props) {
  return (
    <svg viewBox="0 0 32 32" fill="none" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#A3A3A3" fillOpacity={0.2} />
      <path
