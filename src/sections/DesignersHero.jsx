  ...
  return (
    <div {...props}>
      <svg id="evYwQHs7ENb1" viewBox="0 0 863 596">
        ...
        <path d="M688.92,98.67L17.9777,561.678" fill="none" stroke="rgba(212,212,212,0.7)" strokeWidth="2" />
        <path id="evYwQHs7ENb3" d="M688.92,98.67L17.9777,561.678" fill="none" stroke="url(#evYwQHs7ENb3-stroke)" strokeWidth="2" strokeDashoffset="200" strokeDasharray="200" />
        <path d="M520.569,1.31232L445.146,53.6711c-2.29,1.5899-2.616,3.9317-.787,5.6525L551.773,160.375c1.828,1.719,1.504,4.06-.783,5.65L0.937854,548.381" fill="none" stroke="rgba(212,212,212,0.7)" strokeWidth="2" strokeLinecap="round" />
        <path id="evYwQHs7ENb5" d="M520.569,1.31232L445.146,53.6711c-2.29,1.5899-2.616,3.9317-.787,5.6525L551.773,160.375c1.828,1.719,1.504,4.06-.783,5.65L0.937854,548.381" fill="none" stroke="url(#evYwQHs7ENb5-stroke)" strokeWidth="2" strokeDashoffset="200" strokeDasharray="200" />
        <path d="M841.519,197.923l-95.418,62.355c-2.3,1.597-5.97,2.012-8.844,1.001L605.151,190.721c-2.863-1.007-6.518-.599-8.82.984L9.78607,595.122" fill="none" stroke="rgba(212,212,212,0.7)" strokeWidth="2" />
        <path id="evYwQHs7ENb7" d="M841.519,197.923l-95.418,62.355c-2.3,1.597-5.97,2.012-8.844,1.001L605.151,190.721c-2.863-1.007-6.518-.599-8.82.984L9.78607,595.122" fill="none" stroke="url(#evYwQHs7ENb7-stroke)" strokeWidth="2" strokeDashoffset="200" strokeDasharray="200" />
      </svg>
    </div>
  )
}
